...
/**
 * Estilos de botón compartidos dentro de `inmuebles-app` (ver
 * `openspec/changes/ui-layout-navegacion/design.md`, decisión 4: archivo
 * local por microfrontend, no un paquete compartido — mismo patrón conceptual
 * que `frontend/shell/src/styles/buttons.ts`, pero sin importar entre ambos:

# inmuebles-formulario-ui

## Purpose

TBD: define el comportamiento de la interfaz del formulario de publicación de inmuebles (frontend), incluyendo selección de fotos, indicaciones de completitud del formulario y ayudas visuales de entrada de datos.

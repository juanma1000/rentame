...
module.exports = {
  ...
  // Task 7.3 runs jest right after scaffolding, before any test file exists
  // yet (services/pages are added test-first from task 8 onward). Without
  // this, an empty suite would make jest exit non-zero.

 ...
 *
 * In production this module is loaded by the shell (or, cross-remote, by
 * inmuebles-app) via remoteEntry.js. In standalone dev mode (npm start in
 * this directory) it bootstraps a minimal React tree for isolated
 * development and visual verification. Same pattern as
 * inmuebles-app/src/main.tsx.
 */
import('./bootstrap');

# shell-navegacion Specification

## Purpose

Define el layout persistente (header y footer) y la navegación del `shell` de la aplicación, incluyendo el menú consciente de sesión y la conservación del mecanismo de navegación interna existente en la gestión de inmuebles.

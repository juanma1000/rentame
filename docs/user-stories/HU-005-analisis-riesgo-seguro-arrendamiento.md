...
- [x] Tras la aprobación, el sistema genera o facilita la firma del contrato de arrendamiento digital con validez legal en Colombia. (implementado como HU-009, firma-contrato/spec.md — Viafirma; UI en `arrendamiento-app` paso 3)

...
TBD - Capacidad para contratar un seguro de arrendamiento para inquilinos, actuando como intermediario ante un proveedor externo de seguros, sin persistir la documentación de soporte, y modelando el resultado como una póliza (`PolizaArrendamiento`) con estado propio que habilita el avance del proceso de arrendamiento y dispara la notificación al propietario/agente.
